...
public class volaM extends HttpServlet 
{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/gestiondecaisse?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC",
            "root",
            "");
            
            // Préparation de la requête SQL
            String query = "INSERT INTO volamiditra (anarana, fanampiny, daty, maribola, antony, user_id) VALUES (?, ?, ?, ?, ?, ?)";
